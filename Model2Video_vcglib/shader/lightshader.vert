...
void main()
{
    ...
    vec3 LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace0,0)).xyz;
//    LightDirection_cameraspace0 = LightPosition_cameraspace + EyeDirection_cameraspace;
    LightDirection_cameraspace0 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace1,0)).xyz;
    LightDirection_cameraspace1 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace2,0)).xyz;
    LightDirection_cameraspace2 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace3,0)).xyz;
    LightDirection_cameraspace3 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace4,0)).xyz;
    LightDirection_cameraspace4 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace5,0)).xyz;
    LightDirection_cameraspace5 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace6,0)).xyz;
    LightDirection_cameraspace6 = LightPosition_cameraspace;

    LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace7,0)).xyz;
    LightDirection_cameraspace7 = LightPosition_cameraspace;
